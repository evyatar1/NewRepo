...
{
    //movie who won the oscar should be one year less
    public partial class AddOscarWindow : Window
    {
        ...
        private void AddOscarButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                if (OscarYear>2020) throw new ValidationException("Year is not in the correct format(less or equal to 2020)");
                ...
                {
                    if (((from o in ctx.Oscars
                          where (o.Year == OscarYear)
                          select o).ToArray().Length) == 0)
                    {
                        //add Movie Oscar
                        ...
                        resetFields();
                        MessageBox.Show($"The Oscar added to database:\n" +
                                        $"Year:{Oscar.Year}\n" +
                        ...
                        resetFields();
                        MessageBox.Show($"This year already in the database\n" +
                                        $"you can edit oscar in show tab.");
                        MessageBox.Show($"No data added to database.");
                    }
                }
            }
        ...
        private Actor ActorInDatabase(ManageMoviesContext ctx, string OscarActorName,Gender gender)
        {
            ...
            switch (actors.Count()) {
                ...
                default:ChoiceFromDuplicationWindow window = new ChoiceFromDuplicationWindow();
        ...
        {
            tbOscarYear.Text = "";
            tbOscarActorName.Text = "";
            tbOscarActressName.Text = "";
            tbOscarDirectorName.Text = "";
            tbOscarMovieName.Text = "";
        }
